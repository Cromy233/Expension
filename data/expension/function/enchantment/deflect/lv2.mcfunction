...
execute store result entity @n[tag=expension_deflected_proj] Motion[0] double 0.00013 run scoreboard players get @s expension_vector_x
execute store result entity @n[tag=expension_deflected_proj] Motion[1] double 0.00013 run scoreboard players get @s expension_vector_y
execute store result entity @n[tag=expension_deflected_proj] Motion[2] double 0.00013 run scoreboard players get @s expension_vector_z
