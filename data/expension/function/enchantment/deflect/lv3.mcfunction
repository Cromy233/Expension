...
execute at @n[tag=deflect_marker] as @p[advancements={expension:enchantment/deflect/lv3=true}] store result score $player_x expension_deflect run data get entity @s Pos[0] 10000
execute at @n[tag=deflect_marker] as @p[advancements={expension:enchantment/deflect/lv3=true}] store result score $player_y expension_deflect run data get entity @s Pos[1] 10000
execute at @n[tag=deflect_marker] as @p[advancements={expension:enchantment/deflect/lv3=true}] store result score $player_z expension_deflect run data get entity @s Pos[2] 10000
...
execute positioned ~ ~-0.5 ~ anchored eyes run summon arrow ^ ^ ^ {Tags:["deflected_proj"],LeftOwner:0b}
...
### 给予Motion
execute as @e[tag=deflected_proj] store result entity @s Motion[0] double 0.00016 run scoreboard players get $arrow_x expension_deflect
execute as @e[tag=deflected_proj] store result entity @s Motion[1] double 0.00016 run scoreboard players get $arrow_y expension_deflect
execute as @e[tag=deflected_proj] store result entity @s Motion[2] double 0.00016 run scoreboard players get $arrow_z expension_deflect
