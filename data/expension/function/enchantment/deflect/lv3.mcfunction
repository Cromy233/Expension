...
execute store result entity @n[tag=expension_deflect_spawned] Motion[0] double 0.00016 run scoreboard players get @s expension_vector_x
execute store result entity @n[tag=expension_deflect_spawned] Motion[1] double 0.00016 run scoreboard players get @s expension_vector_y
execute store result entity @n[tag=expension_deflect_spawned] Motion[2] double 0.00016 run scoreboard players get @s expension_vector_z
