...
execute unless predicate expension:holding/wind_blade/sweeping_edge_lv1 unless predicate expension:holding/wind_blade/sweeping_edge_lv2 unless predicate expension:holding/wind_blade/sweeping_edge_lv3 as @e[type=#expension:mobs,limit=3,distance=..4,sort=nearest] run damage @s 5 player_attack by @p[advancements={expension:check/wind_blade/use=true}]
execute if predicate expension:holding/wind_blade/sweeping_edge_lv1 as @e[type=#expension:mobs,limit=4,distance=..4,sort=nearest] run damage @s 6 player_attack by @p[advancements={expension:check/wind_blade/use=true}]
execute if predicate expension:holding/wind_blade/sweeping_edge_lv2 as @e[type=#expension:mobs,limit=5,distance=..4,sort=nearest] run damage @s 7 player_attack by @p[advancements={expension:check/wind_blade/use=true}]
execute if predicate expension:holding/wind_blade/sweeping_edge_lv3 as @e[type=#expension:mobs,limit=6,distance=..4,sort=nearest] run damage @s 8 player_attack by @p[advancements={expension:check/wind_blade/use=true}]
