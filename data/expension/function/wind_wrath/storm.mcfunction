...
execute if data entity @s {data:{sweeping_edge:0}} as @n[type=#expension:mobs,distance=..2.5] run damage @s 6 player_attack by @n[tag=expension_wind_wrath_storm]
execute if data entity @s {data:{sweeping_edge:1}} as @n[type=#expension:mobs,distance=..2.6] run damage @s 6 player_attack by @n[tag=expension_wind_wrath_storm]
execute if data entity @s {data:{sweeping_edge:2}} as @n[type=#expension:mobs,distance=..2.8] run damage @s 6 player_attack by @n[tag=expension_wind_wrath_storm]
execute if data entity @s {data:{sweeping_edge:3}} as @n[type=#expension:mobs,distance=..3] run damage @s 6 player_attack by @n[tag=expension_wind_wrath_storm]
