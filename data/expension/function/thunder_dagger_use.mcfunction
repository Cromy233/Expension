execute if score @s thunder_dagger_cooldown matches ..0 run tag @s add thunder_daggle_1
...
execute if entity @s[tag=thunder_daggle_2] run scoreboard players set @s thunder_dagger_cooldown 300
