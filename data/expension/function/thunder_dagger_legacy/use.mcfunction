execute if score @s expension_thunder_dagger_legacy_cooldown matches ..0 run tag @s add thunder_daggle_1
...
execute if entity @s[tag=thunder_daggle_2] run scoreboard players set @s expension_thunder_dagger_legacy_cooldown 300

tag @s remove thunder_daggle_1
tag @s remove thunder_daggle_2
advancement revoke @s only expension:check/thunder_dagger_legacy/use