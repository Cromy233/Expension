...
execute as @n[tag=frost_bow_marker,tag=!frost_bow_marker_used] run ride @s mount @n[tag=frost_bow_arrow,tag=!frost_bow_arrow_fallin]
execute on passengers run tag @s add frost_bow_marker_used
