...
execute unless predicate expension:holding/inferno_whip/fire_aspect_lv1 unless predicate expension:holding/inferno_whip/fire_aspect_lv2 positioned ^ ^ ^2 as @e[type=#expension:mobs,tag=!inferno_whip_exclude,distance=..2] run damage @s 4.5 player_attack by @p[advancements={expension:check/inferno_whip_attack=true}]
execute if predicate expension:holding/inferno_whip/fire_aspect_lv1 positioned ^ ^ ^2 as @e[type=#expension:mobs,tag=!inferno_whip_exclude,distance=..2] run damage @s 5.5 player_attack by @p[advancements={expension:check/inferno_whip_attack=true}]
execute if predicate expension:holding/inferno_whip/fire_aspect_lv2 positioned ^ ^ ^2 as @e[type=#expension:mobs,tag=!inferno_whip_exclude,distance=..2] run damage @s 6.5 player_attack by @p[advancements={expension:check/inferno_whip_attack=true}]
