...
execute as @e[type=minecraft:phantom,distance=..50] run attribute @s max_health modifier add expension:fire_crystal -0.5 add_multiplied_total

advancement revoke @s only expension:check/fire_crystal/phantom